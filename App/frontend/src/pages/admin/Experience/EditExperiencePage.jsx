...
const EditExperiencePage = () => {
  ...
  const fetchExperience = async () => {
    try {
      ...
      const response = await axios.get(`http://localhost:5000/api/experience/${id}`, {
        headers: {
      ...
      console.log('Image URL from API:', experienceData.image_url);
      ...
      if (experienceData.image_url) {
        setImagePreview(getImageUrl(experienceData.image_url));
      }
    } catch (err) {
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  onKeyPress={(e) => e.key === 'Enter' && (e.preventDefault(), handleAddResp())}
                  className={`flex-1 px-4 py-2 rounded-md border ${
                    theme === 'dark' 
                      ? 'bg-gray-800 border-gray-700 text-white' 
                      : 'bg-white border-gray-300 text-gray-800'
